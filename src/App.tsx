...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white font-sans overflow-hidden">
      ...
      {/* Sección principal */}
      <div className="flex flex-col items-center justify-center min-h-screen z-10 relative text-center px-4">
        {/* Imagen fija de perfil */}
      ...
      {/* Contacto y derechos */}
      <footer className="z-10 relative text-center py-6 text-sm text-gray-400">
        <div className="flex justify-center space-x-8 mb-2">
          <p>
            Email:{" "}
            <a
              href="mailto:yorbysxd@gmail.com"
